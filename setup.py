...
setup(
    ...
    # ~ scripts=[
    #   'src-lib/scripts/pyozw_check',
    #   'src-manager/scripts/pyozw_shell'
    # ],
    entry_points={
        'console_scripts': [
    ...
    packages=(
        find_packages('src-lib', exclude=["scripts"]) +
    ...
    download_url=(
        'https://raw.githubusercontent.com/OpenZWave/python-openzwave/master'
        '/archives/python_openzwave-{0}.zip'.format(pyozw_version)
    ),

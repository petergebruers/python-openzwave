...
latex_documents = [
  ('index', 'python-openzwave.tex', u'python-openzwave Documentation',
   u'bibi21000', 'manual'),
]
...
man_pages = [
    ('index', 'python-openzwave', u'python-openzwave Documentation',
     [u'bibi21000'], 1)
]
...
texinfo_documents = [
  ('index', 'python-openzwave', u'python-openzwave Documentation',
   u'bibi21000', 'python-openzwave', 'One line description of project.',
   'Miscellaneous'),
]

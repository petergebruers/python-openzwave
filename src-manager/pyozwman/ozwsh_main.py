...
from .ozwsh_widgets import RootBox
from .ozwsh_widgets import ControllerBox
from .ozwsh_widgets import NodeBox
from .ozwsh_widgets import NodesBox
from .ozwsh_widgets import SensorsBox
from .ozwsh_widgets import SwitchesBox
from .ozwsh_widgets import DimmersBox
from .ozwsh_widgets import ValuesBox
from .ozwsh_widgets import GroupsBox
from .ozwsh_widgets import SceneBox
from .ozwsh_widgets import ScenesBox
from .ozwsh_widgets import StatBox
...
class MainWindow(Screen):
    ...
    def _define_screen(self):
        ...
        self.frame = urwid.Frame(
            urwid.AttrWrap(self.active_box, 'body'),
    ...
    def _disconnect_louie_node_and_value(self):
        ...
        dispatcher.disconnect(
            self._louie_node_update,
            ZWaveNetwork.SIGNAL_NODE
        )
        dispatcher.disconnect(
            self._louie_value_update,
            ZWaveNetwork.SIGNAL_VALUE
        )
        dispatcher.disconnect(
            self._louie_ctrl_message,
    ...
    def _connect_louie_node_and_value(self):
        ...
        dispatcher.connect(
            self._louie_ctrl_message_waiting,
    ...
    def _louie_ctrl_message(
        ...
        self.status_bar.update(
            status='Message from controller: %s' % (state_full,)
        )
        self.loop.draw_screen()

    def _louie_ctrl_message_waiting(
        self,
        network,
        controller,
        state_int,
        ...
        self.status_bar.update(
            status='Message from controller: %s : %s' % (state,state_full,)
        )
        self.loop.draw_screen()

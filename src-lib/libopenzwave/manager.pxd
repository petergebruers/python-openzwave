...
cdef extern from "Manager.h" namespace "OpenZWave":
    ...
    cdef cppclass Manager:
        ...
        bool SetValue(ValueID& valueid, uint8_t _pos, bool value)
...
#~         uint32_t GetAssociations(uint32_t homeid, uint8_t nodeid, uint8_t groupidx, int_associations o_associations)
        ...
        # // Scene commands
        # deprecated uint8_t GetNumScenes()
        # deprecated uint8_t GetAllScenes(uint8_t** sceneIds)
        # deprecated uint8_t CreateScene()
        # deprecated void RemoveAllScenes( uint32_t _homeId )
        # deprecated bool RemoveScene(uint8_t sceneId)
        # deprecated bool AddSceneValue( uint8_t sceneId, ValueID& valueId, bool value)
        # deprecated bool AddSceneValue( uint8_t sceneId, ValueID& valueId, uint8_t value)
        # deprecated bool AddSceneValue( uint8_t sceneId, ValueID& valueId, float value )
        # deprecated bool AddSceneValue( uint8_t sceneId, ValueID& valueId, int32_t value )
        # deprecated bool AddSceneValue( uint8_t sceneId, ValueID& valueId, int16_t value )
        # deprecated bool AddSceneValue( uint8_t sceneId, ValueID& valueId, string value )
        # deprecated bool AddSceneValueListSelection( uint8_t sceneId, ValueID& valueId, string value )
        # deprecated bool AddSceneValueListSelection( uint8_t sceneId, ValueID& valueId, int32_t value )
        # deprecated bool RemoveSceneValue( uint8_t sceneId, ValueID& valueId )
        # deprecated int SceneGetValues( uint8_t sceneId, vector[ValueID]* o_value )
        # deprecated bool SceneGetValueAsBool( uint8_t sceneId, ValueID& valueId, bool* value )
        # deprecated bool SceneGetValueAsByte( uint8_t sceneId, ValueID& valueId, uint8_t* o_value )
        # deprecated bool SceneGetValueAsFloat( uint8_t sceneId, ValueID& valueId, float* o_value )
        # deprecated bool SceneGetValueAsInt( uint8_t sceneId, ValueID& valueId, int32_t* o_value )
        # deprecated bool SceneGetValueAsShort( uint8_t sceneId, ValueID& valueId, int16_t* o_value )
        # deprecated bool SceneGetValueAsString( uint8_t sceneId, ValueID& valueId, string* o_value )
        # deprecated bool SceneGetValueListSelection( uint8_t sceneId, ValueID& valueId, string* o_value )
        # deprecated bool SceneGetValueListSelection( uint8_t sceneId, ValueID& valueId, int32_t* o_value )
        # deprecated bool SetSceneValue( uint8_t sceneId, ValueID& valueId, bool value )
        # deprecated bool SetSceneValue( uint8_t sceneId, ValueID& valueId, uint8_t value )
        # deprecated bool SetSceneValue( uint8_t sceneId, ValueID& valueId, float value )
        # deprecated bool SetSceneValue( uint8_t sceneId, ValueID& valueId, int32_t value )
        # deprecated bool SetSceneValue( uint8_t sceneId, ValueID& valueId, int16_t value )
        # deprecated bool SetSceneValue( uint8_t sceneId, ValueID& valueId, string value )
        # deprecated bool SetSceneValueListSelection( uint8_t sceneId, ValueID& valueId, string value )
        # deprecated bool SetSceneValueListSelection( uint8_t sceneId, ValueID& valueId, int32_t value )
        # deprecated string GetSceneLabel( uint8_t sceneId )
        # deprecated void SetSceneLabel( uint8_t sceneId, string value )
        # deprecated bool SceneExists( uint8_t sceneId )
        # deprecated bool ActivateScene( uint8_t sceneId )
